...
// Bidding closes at the end of 21 September (India time); payments confirmed after this are refunded in full.
export const CLOSE_DATE = '2026-09-21T23:59:59+05:30';
export const CLOSE_LABEL = 'Sep 21, 2026 · 11:59 PM IST';
// Winners can still upload or change logos until the kit goes to print.
export const LOGO_LOCK_DATE = '2026-12-10T00:00:00+05:30';
...
/** The fundraising goal: every spot sold once at its opening bid ($2,090). Takeovers push past 100%. */
export const FUNDING_GOAL = OPENING_PRICES.reduce((sum, price) => sum + price, 0);
