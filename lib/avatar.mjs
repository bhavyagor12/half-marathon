...
export const AVATAR_ANCHORS = [
  ...
  // Sleeve spots sit inside the sleeve silhouette instead of overhanging its edge.
  [-.49, 2.83, .19, .15, 1], [.49, 2.83, .19, .15, 1],
  [0, 2.98, .52, .20, -1], [0, 2.62, .52, .24, -1], [0, 2.28, .52, .19, -1],
  [0, 1.77, .48, .22, -1],
