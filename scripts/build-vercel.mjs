...
for(const file of ['config.ts','avatar.mjs','server.ts','refunds.ts','refund-math.ts','wallet.ts','stats.ts','usdc.ts','base.ts','base-orders.ts'])await cp(new URL(`../lib/${file}`,import.meta.url),new URL(`lib/${file}`,stage));
