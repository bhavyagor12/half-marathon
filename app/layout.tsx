...
const shareImage = {url: '/share.jpg?v=20260912-2', width: 1200, height: 630, type: 'image/jpeg', alt: 'Bhavya in his race kit at a Bengaluru start line with numbered sponsor spots, next to the words “Sponsor my slow run”'};
